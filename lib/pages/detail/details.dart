...
import 'package:book_store_app/database/locator_helper.dart';
import 'package:book_store_app/models/category_feed.dart';
import 'package:book_store_app/view_models/details_provider.dart';
import 'package:book_store_app/widgets/book_list_item.dart';
import 'package:book_store_app/widgets/description_text.dart';
import 'package:book_store_app/widgets/loading_widget.dart';
          ...
          appBar: AppBar(
            actions: <Widget>[
              IconButton(
                ...
                icon: Icon(
                  detailsProvider.faved ? Icons.favorite : FeatherIcons.heart,
        ...
        children: <Widget>[
          Hero(
            ...
            child: CachedNetworkImage(
              ...
              errorWidget: (context, url, error) => Icon(FeatherIcons.x),
              fit: BoxFit.cover,
              height: 200.0,
              width: 130.0,
            ),
